...
!!! tip "Need to run this without an internet connection?"
    See [Offline Setup](offline-setup.md) for how to package a pixi environment and a model's input data so it can be installed and run on a computer with no internet access.
